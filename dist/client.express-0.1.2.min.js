...
ClientExpress.Server=function(){var b=0,a=function(){this.version="0.1.2";this.id=[(new Date).valueOf(),b++].join("-");this.settings={};this.templateEngines={};this.router=new ClientExpress.Router;this.eventListener=new ClientExpress.EventListener;this.log=new ClientExpress.Logger;this.session={};this.content_target_element=document.childNodes[1];this.setup_functions=[]};a.prototype.logger=function(){var c=this;return function(){c.log.enable()}};a.prototype.content_target_area=function(c){var a=
this;return function(){var b=document.getElementById?document.getElementById(c):document.all?document.all[c]:document.layers?document.layers[c]:null;a.content_target_element=b||document.childNodes[1];a.content_target_element==document.childNodes[1]&&a.log.warning('The element "',c,'" could not be located as a content target!')}};a.prototype.configure=function(c){this.setup_functions.push(c)};a.prototype.use=function(c,a){var b=this;if(typeof c=="function")this.setup_functions.push(c);else{c[c.length-
1]==="/"&&(c=c.substring(0,c.length-1));var g=a.router.routes;ClientExpress.utils.forEach(g.get,function(a){d(b,a.method,c+a.path,a.action,c)});ClientExpress.utils.forEach(g.post,function(a){d(b,a.method,c+a.path,a.action,c)});ClientExpress.utils.forEach(g.put,function(a){d(b,a.method,c+a.path,a.action,c)});ClientExpress.utils.forEach(g.del,function(a){d(b,a.method,c+a.path,a.action,c)})}};a.prototype.set=function(c,a){if(a===void 0)if(this.settings.hasOwnProperty(c))return this.settings[c];else{if(this.parent)return this.parent.set(c)}else return this.settings[c]=
a,this};a.prototype.register=function(c,a){if(a===void 0)if(this.templateEngines.hasOwnProperty(c))return this.templateEngines[c];else{if(this.parent)return this.parent.set(c)}else return this.templateEngines[c]=a,this};a.prototype.get=function(c,a){return d(this,"get",c,a,"")};a.prototype.post=function(c,a){return d(this,"post",c,a,"")};a.prototype.put=function(a,b){return d(this,"put",a,b,"")};a.prototype.del=function(a,b){return d(this,"del",a,b,"")};var d=function(a,b,f,d,h){a.log.information(" + ",
b.toUpperCase().lpad("    "),f);a.router.registerRoute(b,f,d,h);return a};a.prototype.processRequest=function(a){var b=this.router.match(a.method,a.path);if(b.resolved()){this.log.information(200,a.method.toUpperCase().lpad("    "),a.path);a.attachRoute(b);var f=new ClientExpress.Response(a,this);a.isHistoryRequest||this.pushState(a);b.action(a,f);f.process()}else this.log.information(404,a.method.toUpperCase().lpad("    "),a.path),a.delegateToServer()};a.prototype.pushState=function(a){history.pushState(a,
a.title,a.location())};a.prototype.replaceState=function(a){history.replaceState(a,a.title,a.location())};a.prototype.listen=function(){if(ClientExpress.supported()){var a=this;ClientExpress.onDomReady(function(){ClientExpress.utils.forEach(a.setup_functions,function(a){a.call()});a.eventListener.registerEventHandlers(a);var b=new ClientExpress.Request({method:"get",fullPath:window.location.pathname,title:document.title,session:a.session,delegateToServer:function(){window.location.pathname=window.location.pathname}});
a.replaceState(b);a.log.information("Listening")})}else a.log.information("Not supported on this browser")};return a}();
ClientExpress.Route=function(){function b(a,b,e){if(a instanceof RegExp)return a;a=a.concat("/?").replace(/\/\(/g,"(?:/").replace(/(\/)?(\.)?:(\w+)(?:(\(.*?\)))?(\?)?/g,function(a,d,e,j,k,i){b.push({name:j,optional:!!i});d=d||"";return""+(i?"":d)+"(?:"+(i?d:"")+(e||"")+(k||"([^/]+?)")+")"+(i||"")}).replace(/([\/.])/g,"\\$1").replace(/\*/g,"(.+)");return RegExp("^"+a+"$",e?"":"i")}var a=function(a,c,e,f,g){this.resolved=function(){return!0};this.method=a;this.path=c;this.action=e;this.base_path=f;
...
ClientExpress.Response=function(){var b=function(a,b){this.request=a;this.server=b;this.output=this.redirect_path=""};b.prototype.send=function(a){this.output=a};b.prototype.render=function(a,b){var c=this.server.settings["view engine"]||"";a=(this.server.settings.views||"")+a;a.lastIndexOf(".")!=-1&&a.lastIndexOf(".")<=4&&(c=a.substr(a.lastIndexOf(".")-1,a.length),a=a.substr(0,a.lastIndexOf(".")-1));c=c||this.server.settings["view engine"]||"";c!=""&&(c="."+c,a+=c);this.send((0,this.server.templateEngines[c])(a,
